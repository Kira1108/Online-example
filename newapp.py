...
fig = go.Figure([
    ...
    go.Scatter(name = 'Arima Pred', x = np.arange(starting, starting + Ntest), y = arima_pred),
    go.Scatter(name = 'Nelson Pred', x = np.arange(starting, starting + Ntest), y = nelson_pred + arima_pred),
])
